---
title: 'Introduction'
description: 'Example section for ClipZap`s API endpoints'
...
<Card
    title="Get your OpenAPI Keys"
    icon="leaf"
    href="https://www.clipzap.ai/workspace/payment"
>
...
2. Using OpenAPI Keys for Production Tasks
